...
L'application se connecte à vos hyperviseurs en utilisant les clés d'API (API tokens) officielles de Proxmox VE et PBS. L'installation est rapide, non intrusive et ne nécessite aucune modification de la configuration de vos serveurs de production.
