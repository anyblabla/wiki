...
J'ai intégré un logo cliquable pour l'identité visuelle de la communauté qui reste ancré dans le coin inférieur gauche de l'écran.
...
| **`bottom: 15px; left: 15px;`** | Ces propriétés ancrent le logo précisément à **15 pixels du bord inférieur et gauche**. |
...
### C. Code HTML/CSS avec logo (Bas à Gauche)
...
### D. Comportement suite à l'implémentation
